...
if not exist "%TAVI_PYTHON%" (
  echo Python with NumPy is required. See README.md.
  pause
  exit /b 1
)
...
"%TAVI_PYTHON%" "%TAVI_PROOF%sculpt_mesh.py"
if errorlevel 1 exit /b 1
"%TAVI_GODOT%" --headless --path "%TAVI_PROOF%." --editor --import --quit --log-file "%TAVI_PROOF%import.log"
if errorlevel 1 exit /b 1
start "Tavi V2 - connected sculpt" "%TAVI_GODOT%" --path "%TAVI_PROOF%." --audio-driver Dummy -- --inspect
exit /b 0
