...
Our first-contact adaptation is specified in [CONTACT_PERFORMANCE_SPEC.md](CONTACT_PERFORMANCE_SPEC.md). The Field Instruments assembly is only one part of presentation. The broader launch should establish home, ship and possibility without forcing a city tutorial or a repetitive mission chain.
