...
Discover worlds worth caring about, personally explore and influence them with your ship and tools, and connect their unusual strengths into a civilization capable of reaching farther. The ancestors' mystery emerges through that expansion and the people affected by it. Read [SPORE_SPACE_STAGE_RESEARCH.md](SPORE_SPACE_STAGE_RESEARCH.md) for the concrete reference mechanics and the distinction between enjoyable personal interaction and repetitive servicing. Richer trade, living planets, diplomacy and history remain endorsed.

Proposed rhythm: follow a signal → fly close and experiment with ship tools → collect or influence something interesting → meet a buyer or establish a specialized foothold → connect a useful supply chain → gain an expedition capability → revisit an old discovery or follow the next lead. Preserve optional personal trading and the satisfaction of the first profitable expedition. Established routine transport can be automated. Include playful discoveries with no mandatory economic purpose.
