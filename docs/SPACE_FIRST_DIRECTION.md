...
Discover worlds worth caring about, learn how their living environments work, and connect their unusual strengths into a civilization capable of reaching farther. The ancestors' mystery emerges through that expansion and the people affected by it.

Proposed rhythm: survey a signal → investigate a world → make a consequential discovery → negotiate access or establish a specialized foothold → connect a useful supply chain → unlock an expedition capability → follow the next lead. Routine transport is automatic. Exploration produces possibilities, not delivery chores.
...
Offer useful automation: minimum reserves, delivery priorities, backup suppliers and warnings for sustained disruption. Report why a route is underperforming. The flagship opens opportunities and responds to exceptional events; it is not the empire's courier.
...
1. **Flight risk test:** an isolated scene with one controllable ship, readable motion cues, collision, one weapon and simple targets; then a few wingmates/enemies. Compare renderers and test controls/frame pacing. This is a technical feasibility test, not an early commitment to build the full combat game.
2. **Expedition art pilot:** one genuinely distinctive authored planet scene, one useful discovery and a clear decision. Human visual/play review is required.
