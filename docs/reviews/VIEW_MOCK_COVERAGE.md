...
Next bounded review: isolated input-driven placement/refusal/retry/cancel sequence using the compact composition, with immediate named slot tooltips and clear equipped-tool versus empty-specimen state. Keep existing costs and prerequisites. Do not expand ecology or integrate production ahead of the every-view gate.
