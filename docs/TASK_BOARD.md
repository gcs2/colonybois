...
| Q01 | Native playtest, accessibility and performance | **Ongoing gate.** 279 assertions plus UI checks pass after the interface change. Twelve added checks cover true storage locations, inspection pause, equipment selection and keyboard access. Rendered layout review completed; native player/fun review pending. | Test actual input, supported window sizes, legibility, listening and clean-PC performance. Automated captures do not establish fun or AAA quality. |
