...
| --- | --- | --- | --- |
| V01 | Visual direction and colorful interactive HUD | **In progress.** Forensic research checkpoint complete; [FLIGHT_INTERFACE.md](FLIGHT_INTERFACE.md) revised around contextual instruments, category palettes, ship display and target states. Current code still uses flat buttons/drawers. Next: composition/state boards and original housing/icon kit, then a connected HUD slice. | Native-input review of targeting, navigation, cargo, shortages, cancellation, sound and legibility; original authored visual identity. User review required. |
...
| V03 | Ship subsystem interface | **Prototype.** Systems / K displays actual energy, recharge, four installed tools, costs/reach/cycle and selection back into flight. Full subsystem simulation, installations, power routing and repair remain absent. | Show actual installed equipment and resource use. Add validated power/activation controls with visible effects; health/repair depend on C01. |
