...
The code audit below describes atlas checkpoint `cfc1020`. Subsequent candidate implementation and rendered evidence are tracked separately in [FLIGHT_HUD_REVIEW.md](../reviews/FLIGHT_HUD_REVIEW.md).
