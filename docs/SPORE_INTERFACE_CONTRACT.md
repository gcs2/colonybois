...
- Earlier gameplay sampling is recorded in [SPORE_GUI_FORENSICS.md](SPORE_GUI_FORENSICS.md). It does not establish frame timing, sound, or native input fidelity.
