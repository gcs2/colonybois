...
Latest review evidence: seven consumable states, six category/capacity states, twelve campaign-backed navigation states and eight projected galaxy states render at1080p/1440p. Dedicated cargo has five actual baseline states plus eleven grid/adjacent-details proposal states at both resolutions, with campaign immutability verified. See [coverage](reviews/VIEW_MOCK_COVERAGE.md). Next obtain fuller source inventory interaction evidence and resolve cargo hover/focus/action-result coverage; the new mock is static, not integrated or accepted. Preserve separate freight, supplies, specimens and surface stock. Preserve unresolved art, text size, gauges, crowding and native-input/motion/audio gates; do not repeat completed bounded pagination corrections. Build20260924-050435 includes the validated defense-preview repair.
