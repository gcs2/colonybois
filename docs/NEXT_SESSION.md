...
Latest review evidence: seven consumable states, six category/capacity states, twelve campaign-backed navigation states and eight projected galaxy states render at1080p/1440p. Dedicated cargo now has five actual baseline states at both resolutions, with campaign immutability verified; these are not redesign mocks. See [coverage](reviews/VIEW_MOCK_COVERAGE.md). Next produce the cargo grid/adjacent-details proposal, preserving separate freight, supplies, specimens and surface stock, and obtain fuller source interaction evidence. Preserve unresolved art, text size, gauges, crowding and native-input/motion/audio gates; do not repeat the completed bounded pagination correction. Build20260924-050435 includes the validated defense-preview repair.
