...
The current prototype implements the small colony/galaxy loop, environment-sensitive growth, simple diplomacy, automatic resource exchange, discoveries, climate projects, ranks, fog, sandbox tools and versioned saves. Its opening is still a small settlement. It does **not** implement the 120,000-person city, the Vanguard, national politics, story actors, multiple jurisdictions per planet, campaign unlocks or battles.
