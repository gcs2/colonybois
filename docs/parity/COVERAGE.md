...
Reference behavior underpinning these boundaries: [Spore research](../research/SPORE_SPACE_STAGE_RESEARCH.md), [interface contract](../reviews/SPORE_INTERFACE_CONTRACT.md), [fleet behavior](https://spore.fandom.com/wiki/Space_fleets), [terraforming](https://spore.fandom.com/wiki/Terraforming), [trade routes](https://spore.fandom.com/wiki/Trade_Route). Acceptance wording above is this project's requirement, not copied retail documentation.
...
- **The recovered pulse ward (old shroud) remains a damage reducer.** A separate purchased timed Shield now blocks flagship damage; Rally Call boosts actual personal/allied fire. Neither provides invisibility; do not count Cloaking Device as implemented. See [SHIP_SUPPORT.md](../systems/SHIP_SUPPORT.md) for scenario values and remaining reference uncertainty.
...
- **The thermal array is still a local planting tool.** Separate [global climate tools](../systems/PLANET_CLIMATE.md) now provide both axes and real colony/diplomatic outcomes. [Specimen collection and plant stabilization](../systems/PLANET_BIOSPHERE.md) now connect to complete food-chain capacity and habitat loss; combined/extreme tools remain missing. Climate potential and ecosystem completion are separate states.
- **The current sector chart is functional travel scaffolding.** [System-scale navigation](../systems/SYSTEM_NAVIGATION.md) now connects real planet destinations and the shared travel clock. Broader planet surfaces, signals, wormholes, the galactic core and final presentation remain open.

## Next implementation target

Subsequent [ship capacity](../systems/SHIP_CAPACITY.md), [repair supply](../systems/REPAIR_SUPPLIES.md), [surface combat](../systems/SURFACE_COMBAT.md) and [allied fleet](../systems/ALLIED_FLEET.md) checkpoints implement purchased hull/energy tiers, finite repair stock, three surface weapon roles and persistent allied escorts with real damage/losses. The manifests above retain their stated implementation-comparison commit. The [climate checkpoint](../systems/PLANET_CLIMATE.md) now adds eight personal axis tools with global visuals, costs and consequences. The [biosphere checkpoint](../systems/PLANET_BIOSPHERE.md) now connects collection, release and ecological stabilization. The [system navigation checkpoint](../systems/SYSTEM_NAVIGATION.md) now connects the planet/system/sector hierarchy to persistent paid travel. [Progression](../systems/EXPEDITION_PROGRESSION.md) now connects ten scenario families to master promotion thresholds, persistent awards, pinning and paid shop alternatives. This is not full reference badge/achievement coverage or master-rank fleet capacity. [Optional orbital signals](../systems/SPACE_SIGNAL_ENCOUNTERS.md) now exercise discovery, commitments, combat/scanning, paid alternatives, deadlines, cancellation/failure and persistent diplomatic outcomes. Captain progression is a distinct-outcome adaptation, not the complete reference mission matrix. Next prioritize **empire hostility, raids and consequential defense (W01)**. Avoid deepening nursery cultivation or expanding the food-web corpus before remaining spaceship breadth. No passive energy regeneration; home recharge stays free.
...
Latest W01 implementation: [empire conflict](../systems/EMPIRE_CONFLICT.md) connects warned hostility, raids, defense investments, personal/allied combat, persistent port damage and peace. This closes no full war-family parity claim: offensive capture/surrender, wider defenses and strategic war AI remain open. Reference scope exclusions are unchanged.
