...
- **The thermal array is still a local planting tool.** Separate [global climate tools](../PLANET_CLIMATE.md) now provide both axes and real colony/diplomatic outcomes. Ecological stabilization and combined/extreme tools remain missing; climate potential is not a stabilized ecosystem.
