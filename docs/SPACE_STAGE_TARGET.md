...
| Weapons, targeting, upgrades, cooldowns, combat | Morrow custodian plus Nacre pursuing raider and Kestrel anchored sentry; latter two have dodgable aim volumes and cargo salvage. Paid emitter modifies real damage. Multiple ships, weapon categories and fleets remain missing | Functional weapon catalog and enemy encounters; meaningful tests and playtests |
...
| Relations, gifts, treaties, alliances, tribute, buyouts | Personal trade pricing, transit pledges, chart-sharing alliance, one-time goodwill, reconciliation, exclusive survey licenses and costly withdrawals work; tribute, buyouts and military commitments remain missing | All interactions catalogued, costed and persistent; visible reactions |
...
| Badges, ranks, alternate unlocks, philosophies | Three badge pilots, case/progress, alternate shop paths and eleven paid upgrades including four hull/four reactor tiers with purchase prerequisites; Defender has only three available contacts; reference families and master ranks remain incomplete | Full progression inventory, meaningful alternate paths, audiovisual achievement delivery |
