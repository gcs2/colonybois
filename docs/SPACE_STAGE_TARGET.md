...
| Badges, ranks, alternate unlocks, philosophies | Three badge pilots, case/progress, alternate shop paths and paid hold/drive/emitter upgrades; Defender has only three available contacts; reference families and master ranks remain incomplete | Full progression inventory, meaningful alternate paths, audiovisual achievement delivery |
