...
The [working reference inventory](parity/COVERAGE.md) now enumerates individual tool families/variants and progression names, with one task-board owner per responsibility and explicit source uncertainties. Subsequent checkpoints add ship survival upgrades, initial surface weapon roles and allied escorts; global climate pulses now integrate personal tools with colony and diplomatic outcomes; ecological stabilization, full weapon/fleet breadth, terrain/color tools, uplift and philosophy powers remain open. Its counts do not establish exhaustive parity or replace native playtests.
...
| Weapons, targeting, upgrades, cooldowns, combat | Three orbital contacts plus six surface defenses. Surface laser, purchased homing missile and ground-area bomb use distinct target rules, energy, cooldowns and delayed impacts; 3D telegraphs, salvage and defeats persist. Full weapon tiers/catalog, fleet support tools and empire war remain open | Functional weapon catalog and enemy encounters; meaningful tests and playtests |
| Allied fleet recruitment, commands, losses | Three faction escorts now have local recruitment, earned capacity, physical formation, selected-target support, actual enemy damage, dock repairs, paid/delayed replacements and loss/recall consequences. Full reference-rank capacity, support tools, broader orders and first-person flight remain open | Persistent fleet ships, ally consequences, usable flight combat |
...
| Badges, ranks, alternate unlocks, philosophies | Three badge pilots, case/progress, alternate shop paths and seventeen paid upgrades including four hull/four reactor tiers with purchase prerequisites; nine distinct contacts allow Defender 3, but not its last two tiers. Reference families and master ranks remain incomplete | Full progression inventory, meaningful alternate paths, audiovisual achievement delivery |
