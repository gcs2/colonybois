...
Built-in imagegen generated two targets from actual project screenshots. Exact [prompts](../reviews/VISUAL_TARGET_PROMPTS_20260923.md) are tracked. Local candidates are `artifacts/visual-targets-20260923/galaxy-v1.png` and `artifacts/visual-targets-20260923/surface-v1.png`. They are ignored, unapproved concept images; their pixels are not backed up in Git. They are not game captures or evidence that any feature is implemented.
