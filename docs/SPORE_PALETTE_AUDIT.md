...
Latest visual/capacity checkpoint: [UI_ICON_VOCABULARY.md](UI_ICON_VOCABULARY.md). Local chart is surface-only. Original icons, two-row pagination, 1080p/1440p renders and 4K geometry are now covered; fixtures are not playable content.
