...
- Unstabilized axes return one point toward native conditions every 30 idle seconds. Ecological stabilization remains unimplemented and is the next connected requirement. Do not call the temporary climate state a finished terraformed ecosystem.
- Climate distance from the center determines T-score. Modified planets use 40/120/240/360 resident growth caps at T0/T1/T2/T3, changed power requirements and local suitability. These small outpost limits are scenario tuning, not the established home city's population model. Existing buildings/residents remain intact.
