...
try {
    ...
    foreach ($testPath in @('tests/test_simulation.gd', 'tests/test_urban.gd', 'tests/test_landing.gd', 'tests/test_city.gd', 'tests/test_ui.gd', 'tests/test_encounter.gd', 'tests/test_equipment.gd', 'tests/test_orbital_threat.gd', 'tests/test_orbital_combat.gd', 'tests/test_flight.gd', 'tests/test_flight_hud.gd', 'tests/test_flight_presentation.gd', 'tests/test_audio.gd', 'tests/test_planet_map.gd')) {
